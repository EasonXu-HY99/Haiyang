...
author: "Xu Haiyang"
image: "https://static-00.iconduck.com/assets.00/shodan-icon-512x512-px4ctshz.png"
format:
  html:
    toc: true
    toc-depth: 3
...
![Shodan Logo](https://static-00.iconduck.com/assets.00/shodan-icon-512x512-px4ctshz.png){fig-align="center" width="200"}
...
From this simple banner, Shodan extracts critical information:
- The web server software (nginx 1.14.2)
- The backend language (PHP 7.4.3)
- The date and time when the server responded
...
![Shodan Search Interface](https://www.shodan.io/static/blogging/content/images/2018/01/maps.png){fig-align="center" width="600"}
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/GI0PblwOc_I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
