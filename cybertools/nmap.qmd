...
date: "2025-03-07"
categories: [Information Gathering, Network Security, Penetration Testing]
author: "Xu Haiyang"
...
![Nmap Host Discovery](https://nmap.org/images/nmap-host-discovery.png){fig-align="center" width="600"}
...
![Nmap OS Detection](https://nmap.org/book/images/nsedoc-ipidseq.png){fig-align="center" width="600"}
...
![Zenmap GUI](https://nmap.org/images/zenmap-main-window.png){fig-align="center" width="700"}
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/4t4kBkMsDbQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
![Security Workflow](https://nmap.org/book/images/ereet-firewall.png){fig-align="center" width="600"}
